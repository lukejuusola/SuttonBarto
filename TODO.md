...
- p58. 3.11, 3.12, 3.13
    - 3.11
        - $ E[ R | S_t=s, A_t=a ] = \sum_{s'} \sum_r p(s', r | s, a) * r$
    - 3.12
...
- p61. 3.17 Bellman Equation for $q_\pi$:
    - $q_\pi(s, a) =  E[ G_t | S_t=s,A_t=a ] =  E[ R_t + \gamma G_{t+1} | S_t=s,A_t=a ]$
    - $= \sum_{s'} \sum_r p(s',  Er | s, a) ( r + \gamma v_pi(s') )$
    - $= \sum_{s'} \sum_r p(s', r | s, a) ( r + \gamma \sum_{a'} \pi(s', a') q_\pi(s', a') )$
- p62. 3.18
    - $v_\pi(s) =  E[ G_t | S_t=s ] = \sum_a \pi(a|s)  E[ G_t | S_t=s,A_t=a ]$
    - $v_\pi(s) =  E[ G_t| S_t=s ] = \sum_a \pi(a|s) q_\pi(s, a)$
- p66. 3.22
    - $\pi = left$
